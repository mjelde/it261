...
switch(THIS_PAGE) {
    ...
    case 'daily.php' :    
       $title = 'Daily Page';
       $mainHeadline = 'Activities to do in Seattle';
       $center = 'center';
       $body = 'daily inner';
       break;
    ...
    case 'people.php' :    
       $title = 'Neighborhoods';
       $mainHeadline = 'Seattle Neighborhoods';
       $center = 'center';
    ...
    case 'contact.php' :    
       $title = 'Contact';
       $mainHeadline = 'Inquire about a Seattle Neighborhood and get a special gift!';
//       $center = 'center';
       $body = 'contact inner';
       break;
    ...
    case 'thx.php' :    
       $title = 'Thank you!';
       $mainHeadline = 'Thank you for your inquiry!';
//       $center = 'center';
       $body = 'thx inner';
       break;
...
$winesErr = 'Please select a neighborhood';
} else {
$wines = $_POST['wines']; 
}
 
if(empty($_POST['comments'])) {
$commentsErr = 'Please provide your comments';
} else {
